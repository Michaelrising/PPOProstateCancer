...
pd.DataFrame.from_dict(MEAN_PARS, orient='index', columns=['r0', 'r1', 'beta1', 'beta2', 'phi', 'gamma', 'betac']).to_csv('average_pars.csv')
pd.DataFrame.from_dict(LOW_CI, orient='index', columns=['r0', 'r1', 'beta1', 'beta2', 'phi', 'gamma', 'betac']).to_csv(
    'csv_file/pars_low_ci.csv')
pd.DataFrame.from_dict(HIGH_CI, orient='index', columns=['r0', 'r1', 'beta1', 'beta2', 'phi', 'gamma', 'betac']).to_csv(
    'csv_file/pars_high_ci.csv')
df_CI = pd.DataFrame.from_dict(CI, orient='index', columns=['r0', 'r1', 'beta1', 'beta2', 'phi', 'gamma', 'betac'])
df_CI[['r0', 'r1', 'beta1', 'beta2']].to_csv('csv_file/pars_ci_14.csv', sep=';')
df_CI[['phi', 'gamma', 'betac']].to_csv('csv_file/pars_ci_57.csv', sep=';')
