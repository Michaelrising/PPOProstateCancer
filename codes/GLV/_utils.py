...
def plot_evolution(Days, PSA, prediction, patientNo, patient_t, summary_path):
    ...
    plt.savefig(summary_path + "/model_plots/" + patientNo + "/PSA_" + str(patient_t) + "-" + patientNo + ".png",
                dpi=100)
    # plt.show()
    plt.close()
    ...
    plt.savefig(
        summary_path + "/model_plots/" + patientNo + "/Cell_All_" + str(patient_t) + "-" + patientNo + ".png",
        dpi=100)
    # plt.show()
    plt.close()
    plt.plot(x, ai, color="black", linestyle="-.", linewidth=1, label="AI")
    ...
    plt.ylabel("Cell counts")
    plt.savefig(
        summary_path + "/model_plots/" + patientNo + "/Cell_AI_" + str(patient_t) + "-" + patientNo + ".png",
        dpi=100)
    # plt.show()
    plt.close()
